...
public class ShowNotiWarringCPUService extends Service {
    ...
    public int onStartCommand(Intent x, int flags, int startId) {
        ...
        bigViews = new RemoteViews(getPackageName(), R.layout.notifi_warning_cpu);
        ...
        bigViews.setOnClickPendingIntent(R.id.layout_notification_cpu, piContent);
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, new Intent(this, RealTimeProcess.class), 0);
