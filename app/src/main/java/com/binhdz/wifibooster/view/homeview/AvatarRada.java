...
public class AvatarRada extends CoordinatorLayout.Behavior<ImageView> {
    ...
    public AvatarRada(Context context, AttributeSet attrs) {
        mContext = context;
    ...
    private void bindDimensions() {
        mAvatarMaxSize = mContext.getResources().getDimension(R.dimen._140sdp);
    }
